...
<html>
<head>
	<title><sitemesh:title default="欢迎光临"/> - ${site.title} - Powered By IFBOY</title>
...
<body>
	<div class="navbar navbar-fixed-top" style="position:static;margin-bottom:10px;">
      <div class="navbar-inner" >
      	 <div class="container">
      	 <img alt="${site.title}" src="${ctxStatic}/front/logo.png" class="container" >
      	 </div>
      </div>
    </div>
	<div class="container">
		...
		<footer>
			...
			<div class="pull-right"><a   href="${pageContext.request.contextPath}${fns:getAdminPath()}" target="_blank">后台管理</a> ${fns:getDate('yyyy年MM月dd日 E')}</div>
