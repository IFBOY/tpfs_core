...
var sArray = new Object;
 sArray[0] = new Image;
 sArray[0].src = ctxStatic+"/star/img/icon_star_1.gif";
 for (var i=1; i<6; i++) {
  sArray[i] = new Image();
  sArray[i].src = ctxStatic+"/star/img/icon_star_2.gif";
}
 var starTimer;
 var pro ;
 var rate ;
 function initStar() {
  try {
   /*setProfix("helpfull_");
   setStars(document.getElementById("helpfull_").value,'helpfull');
   setProfix("difficulty_");
   setStars(document.getElementById("difficulty").value,'difficulty');*/
  } catch(e){
  }
 }
